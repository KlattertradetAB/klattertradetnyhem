...
export const Chapter1: React.FC = () => {
  return (
    <div id="chap1">
      ...
      <p className="mb-6 text-justify leading-relaxed hyphens-auto">
        Trauma är ett ord vi ofta associerar med krig, olyckor eller naturkatastrofer, men MiT uppstår i en mer subtil, men ack så destruktiv kontext: när en individ, eller flera individer inom ett system som en familj, utsätts för ingripanden från en myndighet.
     </p>
      ...
      <p className="mb-6 text-justify leading-relaxed hyphens-auto">
        En central aspekt som förvärrar MiT är det Eva Langes teori kallar våldets normalisering. Den utsatta personen börjar skuldbelägga sig själv, och det destruktiva narrativet – att individen "gjort ett olyckligt fel" – blir deras sanning. Detta kan leda till att det utåt sett uppfattas som att individen är den som har en problematik, såsom "Kverulantparanoia". Den drabbade individen slutar kämpa, och i slutändan upplevs det som att ha blivit "medborgare noll".
      </p>
      <p className="mb-6 text-justify leading-relaxed hyphens-auto">
