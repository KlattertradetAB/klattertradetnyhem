...
export const LogoIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 4c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z" />
...
export const CoffeeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h14v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2z"></path><path d="M4.5 4.5L6 9L11 11L6 13L4.5 17.5L3 13L-2 11L3 9L4.5 4.5z"></path></svg>
);

export const BookIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
);
...
export const AppleIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M19.1 13.43a4.34 4.34 0 0 1-4.33 4.32 4.33 4.33 0 0 1-4.31-4.32 4.32 4.32 0 0 1 4.31-4.31 4.31 4.31 0 0 1 4.33 4.31z" opacity=".08"></path><path d="M19.34 13.29a4.51 4.51 0 0 1-1.11 3.16 4.49 4.49 0 0 1-3.16 1.11 4.5 4.5 0 0 1-3.32-1.27 4.52 4.52 0 0 1-1.28-3.32A4.52 4.52 0 0 1 11.75 9a4.52 4.52 0 0 1 3.32-1.28A4.52 4.52 0 0 1 18.23 9a4.5 4.5 0 0 1 1.27 3.32 4.48 4.48 0 0 1-.16.97z" opacity=".12"></path><path d="M16.48 5.43A4.8 4.8 0 0 0 15 5.07a4.16 4.16 0 0 0-2.43.79 4.21 4.21 0 0 0-1.6 3.82 4.21 4.21 0 0 0-1.6 3.82 4.19 4.19 0 0 0 .8 2.45 4.22 4.22 0 0 0 3.83 1.61 4.2 4.2 0 0 0 3.06-1.2 1.22 1.22 0 0 0 .34-.44 3.1 3.1 0 0 1-2.12-.89 3.08 3.08 0 0 1-.9-2.11 3.08 3.08 0 0 1 .89-2.08 3.05 3.05 0 0 1 2.1-.92 1.49 1.49 0 0 0 .42-.31z"></path><path d="M15.22 4.48a4.5 4.5 0 0 0-2.73 1 4.53 4.53 0 0 0-1.72 4.09 4.53 4.53 0 0 0 .85 2.62 4.52 4.52 0 0 0 4.08 1.72 4.51 4.51 0 0 0 3.27-1.27 1.45 1.45 0 0 0 .33-.48 3.42 3.42 0 0 1-2.25-.94 3.38 3.38 0 0 1-.94-2.25 3.4 3.4 0 0 1 .95-2.28 3.42 3.42 0 0 1 2.27-.95.83.83 0 0 0 .1-.63 1.27 1.27 0 0 0-.44-.44z"></path>
    </svg>
);

export const GooglePlayIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M4.69 3.55a2.15 2.15 0 0 0-1.2 3.72l5.77 3.34-5.77 3.33a2.15 2.15 0 0 0 1.2 3.72l7.15-4.12a2.13 2.13 0 0 0 0-3.71z"></path><path d="M12.44 12 7.15 15.88a2.14 2.14 0 0 0 2.29 1.15l5.22-3a2.13 2.13 0 0 0 2.16-1.85v-6.3a2.14 2.14 0 0 0-2.16-1.85l-5.22-3a2.14 2.14 0 0 0-2.3 1.15z" opacity=".5"></path><path d="M12.44 12 7.15 8.12a2.14 2.14 0 0 1 2.29-1.15l5.22 3a2.13 2.13 0 0 1 2.16 1.85v.06a2.14 2.14 0 0 1-2.16 1.85l-5.22 3a2.14 2.14 0 0 1-2.3-1.15z" opacity=".08"></path><path d="m14.73 13.15 5.22-3a2.14 2.14 0 0 0-1.08-3.92l-5.22 3a2.14 2.14 0 0 0 1.08 3.92z" opacity=".12"></path>
    </svg>
);
...
export const LoaderIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <line x1="16.24" y1="7.76" x2="19.07" y2="4.22"></line>
    </svg>
);
