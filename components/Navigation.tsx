              ...
              <div className="glass bg-black/95 backdrop-blur-3xl border border-white/20 rounded-2xl p-6 flex flex-col gap-4 shadow-2xl max-h-[80vh] overflow-y-auto no-scrollbar">
                ...
                <div className="bg-white/5 rounded-2xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-1">
                    ...
                    <a href={PAGE_URLS[Page.CHAT]} onClick={(e) => handleNavClick(Page.CHAT, e)} className={`w-full py-3 rounded-xl font-medium text-left px-4 text-sm transition-colors ${currentPage === Page.CHAT ? 'text-orange-400 bg-white/10' : 'text-white/70 hover:bg-white/5'}`}>Myndighetsinducerat trauma</a>
